    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2709), 1, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2710), 1, "Kitchen" },
                    { 2, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2712), 1, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2713), 1, "Bedroom" },
                    { 3, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2715), 1, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2715), 1, "Guest room" },
                    { 4, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2717), 1, new DateTime(2024, 9, 21, 19, 45, 44, 504, DateTimeKind.Utc).AddTicks(2717), 1, "Bathroom" }
                });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "CreatedDate", "CreatedId", "UpdatedDate", "UpdatedId", "Value" },
                values: new object[] { 1, new DateTime(2024, 9, 21, 19, 45, 44, 503, DateTimeKind.Utc).AddTicks(1443), 1, new DateTime(2024, 9, 21, 19, 45, 44, 503, DateTimeKind.Utc).AddTicks(1446), 1, "Admin" });
